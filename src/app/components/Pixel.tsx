...
const PixelgradeExperience: React.FC<PixelgradeExperienceProps> = ({
  imageSrc,
  title,
  description,
  buttonText,
  ...
  return (
    <section className="bg-neutral-100 p-10">
      <div className="grid grid-cols-2 gap-6 items-center px-24 max-md:px-5 max-md:grid-cols-1">
        ...
        <div className="flex flex-col items-start max-md:mt-6">
          <h2 className="text-3xl font-semibold leading-8 text-neutral-800">
            {title}
          </h2>
          ...
          {/* Correct Link to CommunityManagementServices Page */}
          <Link href="/Register">
...
export default PixelgradeExperience;
